...
from core.management_views import (
    ...
    InsuranceListView,
    InsuranceDetailView,
    HospitalItemListView,
    HospitalItemDetailView,
    HospitalBulkUploadView,
    InsuranceCompanyListView,
    InsuranceCompanyDetailView,
    VisitCommentListView,
    VisitCommentDeatilView,
)
...
urlpatterns = [
    ...
    path(
        "hospital-items/<int:pk>/",
        HospitalItemDetailView.as_view(),
        name="hospital-item-detail",
    ),
    path(
        "hospital-items/bulk-upload/",
        HospitalBulkUploadView.as_view(),
        name="hospital-item-bulk-upload",
    ),
    # Item type URLs
    ...
    path(
        "insurance-companies/",
        InsuranceCompanyListView.as_view(),
        name="insurance-company-list",
    ),
    path(
        "insurance-companies/<int:pk>/",
        InsuranceCompanyDetailView.as_view(),
        name="insurance-company-detail",
    ),
    path(
        "visits/visit-comments/<int:visit_id>/",
        VisitCommentListView.as_view(),
        name="visit-comments",
    ),
    path(
        "visits/visit-comments/detail/<int:pk>/",
        VisitCommentDeatilView.as_view(),
        name="comment-detail",
    ),
]
